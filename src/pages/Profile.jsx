					...
					<div className='mt-32 sm:mt-36'>
						{session_token && (
							<div className='flex flex-row gap-4 place-content-center'>
								<Link
									to='/profile/edit'
									className='flex flex-row gap-2 items-center bg-brown text-white font-medium px-5 py-2 rounded-full hover:bg-[#552b1a] duration-150'>
									<AiFillEdit />
									Edit Profile
								</Link>
								<button
									to=''
									className='flex flex-row gap-2 items-center bg-brown text-white font-medium px-4 py-2 rounded-full hover:bg-[#552b1a] duration-150'
									onClick={copyProfile}>
									<AiFillProfile />
									Share Profile
								</button>
						...
						<div className='font-primary xxxsm: flex flex-col gap-6 mt-12 m-xxxsm'>
							...
							<p className='text-sm leading-4 text-[#919191] text-center border border-[#4e4e4e] py-6 px-10 rounded-lg m-auto xxxsm:w-full sm:w-6/12 lg:w-5/12 xl:w-3/12'>
								{userDeets.bio}
							</p>
						</div>
						...
						{!userDeets.rates || userDeets.rates.length === 0 ? (
							<div className='xxxsm: flex flex-col gap-2 text-center mt-24 mx-xxxsm'>
								...
								{session_token && (
									<Link
										to='/cafes'
										className='mt-2 xxxsm: border-2 border-brown rounded-full py-2 text-white font-bold cursor-pointer m-auto w-full sm:w-6/12 lg:w-5/12 xl:w-3/12'>
										Rate Now
									</Link>
								)}
							</div>
