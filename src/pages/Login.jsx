	...
	return (
		<div>
			...
			<div className='xxxsm:w-11/12 m-auto bg-[#232323] p-4 rounded-lg mt-14 sm:w-6/12 md:w-4/12 p-6 xl:w-3/12 xxl:w-3/12'>
				<p className='xxxsm:font-primary text-white text-xs sm:text-lg xxl:mt-4'>
					Welcome Back!
				</p>
				<h1 className='xxxsm:font-primary text-cream text-4xl font-extrabold tracking-wide mb-4 sm:text-6xl'>
					Log In
				</h1>
				<form
					className='flex flex-col gap-4 text-xs xxl:mt-8'
					...
					{loginMessage && <p className='text-red-500 text-xs'>{loginMessage}</p>}
					<div className='relative font-primary'>
						...
						<p className='font-primary text-xs text-white mt-4 text-center sm:text-base'>
							...
							<span className='font-primary italic underline text-cream font-bold'>
