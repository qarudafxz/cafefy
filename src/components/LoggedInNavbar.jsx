						...
						<div className='flex flex-col gap-4 mt-14'>
							<form>
								<div className='flex flex-row gap-4'>
									<input
										type='text'
										placeholder='Search cafes'
										className='w-9/12 py-2 pl-6 rounded-3xl focus:outline-none bg-transparent border border-white font-primary text-white'
									/>
									<Link
										to={{
											pathname: `/profile/${userID}`,
							...
							<div className='flex flex-col gap-2 cursor-pointer text-white text-sm'>
								...
								<div className='flex flex-row items-center'>
									...
									<Link to='/cafes/favorite_cafes'>Favourite Cafes</Link>
								</div>
								<div className='flex flex-row items-center'>
								...
								<button
									className='bg-brown rounded-3xl py-1 font-bold text-lg text-ellipsis'
									onClick={toggleLogout}>
									Logout
								</button>
							</div>
